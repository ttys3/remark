...
| ------------------ | --------------------------- | ------------------ | ------------------------------ | ------- | -------------- | ------------------- |
| smtp.host          | email.smtp.host             | SMTP_HOST          | EMAIL_SMTP_HOST                |         | smtp host      | 1.5.1               |
| smtp.port          | email.smtp.port             | SMTP_PORT          | EMAIL_SMTP_PORT                |         | smtp port      | 1.5.1               |
| smtp.username      | email.smtp.username         | SMTP_USERNAME      | EMAIL_SMTP_USERNAME            |         | smtp user name | 1.5.1               |
| smtp.password      | email.smtp.password         | SMTP_PASSWORD      | EMAIL_SMTP_PASSWORD            |         | smtp password  | 1.5.1               |
| smtp.tls           | email.smtp.tls              | SMTP_TLS           | EMAIL_SMTP_TLS                 | `false` | enable TLS     | 1.5.1               |
| smtp.timeout       | email.smtp.timeout          | SMTP_TIMEOUT       | EMAIL_SMTP_TIMEOUT             | `10s`   | smtp timeout   | 1.5.1               |
</details>
